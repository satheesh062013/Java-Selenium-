...
public class Xls_Reader {
	...
	public boolean setCellData(String sheetName,String colName,int rowNum, String data,String url){
	   ...
	   // XSSFHyperlink link = createHelper.createHyperlink(XSSFHyperlink.LINK_FILE); //SATHEESH COMMENTED
	   // link.setAddress(url);														  //SATHEESH COMMENTED
	   // cell.setHyperlink(link);												      //SATHEESH COMMENTED
	    cell.setCellStyle(hlink_style);
	...
	public boolean removeColumn(String sheetName, int colNum) {
		...
		style.setFillForegroundColor(HSSFColor.GREY_40_PERCENT.index);
		XSSFCreationHelper createHelper = workbook.getCreationHelper();
		//style.setFillPattern(HSSFCellStyle.NO_FILL);					//SATHEESH COMMENTED
